...
public final class AbnormalitiesEntityDataSerializers {
	public static final DeferredRegister<EntityDataSerializer<?>> REGISTRY = Abnormalities.modRegister(NeoForgeRegistries.Keys.ENTITY_DATA_SERIALIZERS);
	...
	private static <T> DeferredHolder<EntityDataSerializer<?>, EntityDataSerializer<T>> register(String name, EntityDataSerializer<T> serializer) {
		return AbnormalitiesEntityDataSerializers.REGISTRY.register(name, () -> serializer);
	}
}
