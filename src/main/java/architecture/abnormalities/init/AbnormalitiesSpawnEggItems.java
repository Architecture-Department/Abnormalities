...
public class AbnormalitiesSpawnEggItems {
	public static final DeferredRegister.Items REGISTRY = DeferredRegister.createItems(Abnormalities.ID);
	...
	private static DeferredItem<SpawnEggItem> register(
		...
		return register(id, zhName, itemProperties -> new architecture.abnormalities.common.item.ModEggItem(entityType, properties), properties);
	}
